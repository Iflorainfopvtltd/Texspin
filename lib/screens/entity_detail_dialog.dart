...
class _EntityDetailDialogState extends State<EntityDetailDialog> {
                                  ...
                                  CustomButton(
                                    ...
                                    onPressed: state.isCreating
                                        ...
                                        : () {
                                            ...
                                            if (_selectedRole == 'manager') {
                                              requiredFields.add('workCategory');
                                            }
  ...
  void _openStaffEditDialog(dynamic entity) {
    ...
    _genderController.text = entity.gender ?? '';
    _selectedGender = (entity.gender ?? '').toString().toLowerCase();
    ...
    // Debug: Print workCategory value
    print('Opening edit dialog for staff: ${entity.id}');
    print('entity.workCategory: ${entity.workCategory}');
    print('_selectedWorkCategoryId: $_selectedWorkCategoryId');
                ...
                BlocListener<EntityBloc, EntityState>(
                  ...
                  listener: (context, state) {
                    ...
                    if (_selectedDesignationId != null &&
                        !state.designations.any((d) => d.id == _selectedDesignationId)) {
                    ...
                    if (_selectedWorkCategoryId != null &&
                        !state.workCategories.any((wc) => wc.id == _selectedWorkCategoryId)) {
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              CustomDropdownButtonFormField<String>(
                                ...
                                hint: 'Select gender',
                                value:
                                    const ['male', 'female', 'other'].contains(
                                      (_selectedGender ?? '').toLowerCase(),
                                    )
                                    ? (_selectedGender ?? '').toLowerCase()
                                    : null,
                                ...
                                onChanged: (val) =>
                                    setStateDialog(() => _selectedGender = val),
                              ),
                              const SizedBox(height: 12),
                              CustomDropdownButtonFormField<String>(
                                label: 'Designation',
                              ...
                              CustomDropdownButtonFormField<String>(
                                ...
                                items: state.zones
                                    ...
                                    .toList(),
                                onChanged: (val) =>
                                    setStateDialog(() => _selectedZoneId = val),
                              ),
                              const SizedBox(height: 12),
                              CustomDropdownButtonFormField<String>(
                                label: 'Department',
  ...
  void _saveTemplatePhase(BuildContext context, EntityState state) {
    final customPhaseName = _currentTemplatePhaseNameController.text.trim();
    ...
    final activitiesList = _currentTemplateActivities.map((activity) {
      final activityName = activity['name'].toString();
      ...
      return Column(
        ...
        children: [
          ...
          CustomDropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              if (value != null) {
                final selectedPhase = state.phases.firstWhere((p) => p.name == value);
                setStateDialog(() {
                                ...
                                children: [
                                  Expanded(
                                    child: CustomDropdownButtonFormField<String>(
                                      ...
                                      value: activity['name'].toString().isEmpty
                                          ? null
                                          : (state.activities.any((a) =>
                                      ...
                                      onChanged: (value) {
                                        if (value != null) {
                                          final selectedActivity = state.activities
                                              .firstWhere((a) => a.name == value);
                                          setStateDialog(() {
                                            _updateTemplateActivity(
                                                activityId, 'name', value);
                                            _updateTemplateActivity(activityId,
          ...
          CustomButton(
            text: 'Save Phase',
            onPressed: ((_currentTemplatePhaseName.isNotEmpty ||
                    _currentTemplatePhaseNameController.text.trim().isNotEmpty) &&
            ...
            itemBuilder: (BuildContext context) {
              ...
              items.add(
                const PopupMenuItem<String>(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.delete_outline, size: 18, color: AppTheme.red500),
                      SizedBox(width: 8),
