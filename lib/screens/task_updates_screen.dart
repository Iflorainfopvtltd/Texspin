...
class _TaskUpdatesScreenState extends State<TaskUpdatesScreen> {
  ...
  Widget _buildMobileView() {
    return Column(
      children: _approvals.map((approval) => _buildMobileCard(approval)).toList(),
    );
  }
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: CustomButton(
                    ...
                    variant: ButtonVariant.outline,
                    size: ButtonSize.sm,
                    icon: const Icon(Icons.download, size: 16, color: AppTheme.blue600),
                  ),
                ),
              ),
            Row(
        ...
        children: [
          ...
          DataTable(
            ...
            columns: const [
              ...
              DataColumn(label: Text('Uploaded By', style: TextStyle(fontWeight: FontWeight.w600))),
              DataColumn(label: Text('Actions', style: TextStyle(fontWeight: FontWeight.w600))),
            ],
            rows: _approvals.map((approval) => _buildDataRow(approval)).toList(),
          ),
        ],
      ),
    );
