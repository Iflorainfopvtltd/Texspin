...
class StaffIndividualTaskDetailsDialog extends StatelessWidget {
  final Task task;

  const StaffIndividualTaskDetailsDialog({super.key, required this.task});
  ...
  Widget _buildBasicInfoSection(bool isMobile) {
    return _buildSection('Basic Information', Icons.info_outline, [
      ...
      _buildInfoRowDetail('Deadline', _formatDate(task.deadline)),
