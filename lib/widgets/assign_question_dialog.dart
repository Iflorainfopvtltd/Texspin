...
class _AssignQuestionDialogState extends State<AssignQuestionDialog> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Currently assigned to: ${_getCurrentAssignedStaffName()}',
                  ...
                  if (widget.question['deadline'] != null)
                    Text(
                      'Current deadline: ${DateTime.parse(widget.question['deadline']).toString().split(' ')[0]}',
                      style: const TextStyle(
                        fontSize: 14,
                        color: AppTheme.gray700,
                      ),
  ...
  String _getCurrentAssignedStaffName() {
    if (widget.question['assignedTo'] != null) {
      final assignedStaff = _staff.firstWhere(
        (staff) => staff.id == widget.question['assignedTo'],
        orElse: () => Staff(
          id: '',
          staffId: '',
