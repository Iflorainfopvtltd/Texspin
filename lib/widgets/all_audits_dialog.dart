        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildInfoRow(Icons.description, template),
              const SizedBox(height: 8),
              _buildInfoRow(Icons.business, company),
              const SizedBox(height: 8),
              _buildInfoRow(Icons.quiz, '${questions.length} Questions'),
              const SizedBox(height: 12),
              Row(
...
class _AuditDetailsDialog extends StatelessWidget {
  ...
  const _AuditDetailsDialog({required this.audit});
...
class _AuditQuestionsDialogState extends State<_AuditQuestionsDialog> {
  ...
  DataRow _buildQuestionRow(Map<String, dynamic> question) {
    ...
    final status = question['status'] ?? 'Pending';
    final assignedTo = question['assignedTo'] ?? '';
    ...
    return DataRow(
      cells: [
        ...
        DataCell(Text(assignedTo.isNotEmpty ? 'Assigned' : 'Not Assigned')),
