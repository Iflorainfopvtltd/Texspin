...
class StaffIndividualTaskSubmissionDialog extends StatefulWidget {
  final Task task;
  final VoidCallback onSubmitted;

  const StaffIndividualTaskSubmissionDialog({
    super.key,
    required this.task,
  ...
  @override
  State<StaffIndividualTaskSubmissionDialog> createState() =>
      _StaffIndividualTaskSubmissionDialogState();
}

class _StaffIndividualTaskSubmissionDialogState
    extends State<StaffIndividualTaskSubmissionDialog> {
  ...
  Widget _buildContent(BuildContext context, bool isMobile) {
    return Column(
      ...
      children: [
        ...
        // Submit Button (Floating/Fixed at bottom for mobile?)
        // In this design, let's keep it at the bottom of the column for Dialog
        // For Mobile, we can put it in bottomNavigationBar or keep it here.
        // Let's keep it here but ensure padding.
        Container(
      ...
      children: [
        ...
        _buildDetailItem(
          ...
          widget.task.deadline != null
              ...
              : (widget.task.isRecurringActive == true ? 'Recurring' : 'N/A'),
        ),
        _buildDetailItem(
          'Assigned By',
